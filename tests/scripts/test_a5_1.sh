...
mkdir debug &&
cd ../../ &&
./gradlew run --args="-c tests/examples/A5_1/A5_1.class -s A5_1 -m generate:([Z[Z[Z)[Z --output tests/scripts/debug/a51_java.aag --array-sizes 19 --array-sizes 22 --array-sizes 23" &&
cd tests/scripts/ &&
