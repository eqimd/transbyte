...
def make_header_and_comments(len_clauses_list, max_var, inputs_names, vars_dict, outputs_names, layers_vars):
  ...
  comments = [comment_inputs, comment_vars, comment_outputs, comment_layers]
...
if __name__ == '__main__':
  ...
  header, comments = make_header_and_comments(len(clauses_list), max_var, inputs_names, vars_dict, outputs_names, layers_vars)
